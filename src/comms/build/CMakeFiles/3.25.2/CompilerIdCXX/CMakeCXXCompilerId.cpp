...
/* __INTEL_COMPILER = VRP prior to 2021, and then VVVV for 2021 and later,
    ...
    #define COMPILER_ID "IntelLLVM"
        ...
        #define SIMULATE_ID "GNU"
    #endif
    /* __INTEL_LLVM_COMPILER = VVVVRP prior to 2021.2.0, VVVVRRPP for 2021.2.0
     * and later.  Look for 6 digit vs. 8 digit version number to decide
     * encoding. VVVV is no smaller than the current year when a version is
     * released.
     */
